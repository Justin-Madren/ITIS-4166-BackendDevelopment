...
router.put('/:id',authenticate, validateId, authorizeOwnership, validateUpdatePost, updatePostHandler);
router.delete('/:id', authenticate, validateId, authorizeOwnership, deletePostHandler);
